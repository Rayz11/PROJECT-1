...
<head>
	...
	<title>Night Jobs hub - Academic Qualifications</title>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<div class="admin-user-action text-center">
										...
										<a target="_blank" href="view-certificate.php" class="btn btn-primary btn-sm btn-inverse">View my CV</a>
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="applied-jobs.php"><i class="fa fa-bookmark"></i>View Applied Jobs</a>
										</li>
										<li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
							        ...
							        <div class="form-group"> 
								    <label>Certificate or Resume <i>(Leave blank if you dont want to update)</i></label>
							        ...
							        <div class="form-group"> 
								    <label>Curriculum Vitae <i>(Leave blank if you dont want to update)</i></label>
