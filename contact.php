...
<head>
	...
	<title>Night Jobs hub - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Nairobi, <br/> Kenya,</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:rayzken6@gmail.com">rayzken6@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+254 714 871 641">+254 714 871 641</a>
								</li>
